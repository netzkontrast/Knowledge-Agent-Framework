# Spec Panel Critique — IW Little Data Agent Design v1

> **This is the panel critique of the IW Little Data reference example's design** (see `examples/iw-little-data/`) — part of the **Knowledge Agent Framework**.
> **Spec under review:** `iw-little-data-agent-design.md` (Draft v1)
> **Mode:** critique
