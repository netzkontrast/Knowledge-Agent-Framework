# Jules Work-Unit: little-data Knowledge-File `05-integrationen-und-mcp`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/05-integrationen-und-mcp.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `05-integrationen-und-mcp`.
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/05-integrationen-und-mcp.md` |
| **H1** | `Integrationen und MCP für Marketing-Direktoren (Beratung)` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - 60+ native Integrationen Überblick (kategorisiert)
...
| **Marketing-Funktionen-Fokus** | CRM, MarketingOps, Analytics, Internal-Enablement |
...
### S-IM-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/05-integrationen-und-mcp.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 05-integrationen-und-mcp via Jules`.
...
> "Done. 05-integrationen-und-mcp: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
