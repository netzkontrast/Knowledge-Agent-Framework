# Jules Work-Unit: little-data Knowledge-File `08-sicherheit-und-governance`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/08-sicherheit-und-governance.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `08-sicherheit-und-governance`.
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/08-sicherheit-und-governance.md` |
| **H1** | `Sicherheit und Governance für Marketing-Direktoren` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - DSGVO und EU-Hosting (Azure EU-Region)
- ISO 27001 und SOC 2 Type II Zertifizierungen
- Datenresidenz und Trainings-Opt-out (Langdock nutzt KUNDENDATEN NIE für Modell-Training)
...
| **Marketing-Funktionen-Fokus** | Compliance, Internal-Enablement, MarketingOps |
...
### S-SG-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/08-sicherheit-und-governance.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 08-sicherheit-und-governance via Jules`.
...
> "Done. 08-sicherheit-und-governance: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
