# Jules Work-Unit: little-data Knowledge-File `09-marketing-praxis`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/09-marketing-praxis.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `09-marketing-praxis`.
...
- little-data/data/extracts/T3-marketing-praxis.md
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/09-marketing-praxis.md` |
| **H1** | `Marketing-Praxis für Marketing-Direktoren` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - Top-10 Quick Wins für Beginner (die ersten 30 Minuten)
...
| **Marketing-Funktionen-Fokus** | alle Funktionen (cross-cutting Playbook) |
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/09-marketing-praxis.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 09-marketing-praxis via Jules`.
...
> "Done. 09-marketing-praxis: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
