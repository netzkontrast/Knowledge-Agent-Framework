# Jules Work-Unit: little-data Knowledge-File `01-chat-und-prompts`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/01-chat-und-prompts.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `01-chat-und-prompts`.
...
- little-data/data/sources/05-langdock-tipps-tricks-anwendungsfaelle.md
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/01-chat-und-prompts.md` |
| **H1** | `Chat und Prompts für Marketing-Direktoren` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - Chat-Oberfläche und Tastatur-Shortcuts (Cmd-K, Chat-Branching, PWA)
...
| **Marketing-Funktionen-Fokus** | Content, Brand, Prompt-Engineering, Internal-Enablement |
...
### S-CP-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/01-chat-und-prompts.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 01-chat-und-prompts via Jules`.
...
> "Done. 01-chat-und-prompts: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
