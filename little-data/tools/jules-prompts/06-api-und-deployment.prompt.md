# Jules Work-Unit: little-data Knowledge-File `06-api-und-deployment`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/06-api-und-deployment.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `06-api-und-deployment`.
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/06-api-und-deployment.md` |
| **H1** | `API und Deployment für Marketing-Direktoren (Beratung)` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - Wann eine Marketing-Direktorin überhaupt mit API in Berührung kommt
...
| **Marketing-Funktionen-Fokus** | MarketingOps, Internal-Enablement |
...
### S-AD-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/06-api-und-deployment.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 06-api-und-deployment via Jules`.
...
> "Done. 06-api-und-deployment: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
