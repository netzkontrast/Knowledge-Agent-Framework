# Jules Work-Unit: little-data Knowledge-File `03-wissensordner-und-rag`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/03-wissensordner-und-rag.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `03-wissensordner-und-rag`.
...
- little-data/data/research/04-rag-bootstrap-session-start-patterns.md
- little-data/data/sources/13-langdock-knowledge-file-methodology.md
- little-data/data/sources/15-langdock-knowledge-file-authoring-methodology-gemini.md
- little-data/data/restructured/01-knowledge-authoring-methodology.md
- little-data/data/sources/07-langdock-knowledge-authoring-methodology.md
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/03-wissensordner-und-rag.md` |
| **H1** | `Wissensordner und RAG für Marketing-Direktoren` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - Wissensordner versus direkter Anhang (Entscheidungsmatrix)
...
| **Marketing-Funktionen-Fokus** | Brand, Content, MarketingOps, Internal-Enablement |
...
### S-WR-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/03-wissensordner-und-rag.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 03-wissensordner-und-rag via Jules`.
...
> "Done. 03-wissensordner-und-rag: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
