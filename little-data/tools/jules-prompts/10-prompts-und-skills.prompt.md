# Jules Work-Unit: little-data Knowledge-File `10-prompts-und-skills`
...
Schreibe die Knowledge-Datei `little-data/langdock-deploy/knowledge/10-prompts-und-skills.md` für den Langdock-Wissensordner des "Little Data" Beratungsagenten. Zielgruppe: eine strategisch arbeitende, hands-on-orientierte Marketing-Direktorin (DACH).
...
3. `little-data/data/coverage-matrix.md` — die Rows für deine Datei `10-prompts-und-skills`.
...
| Feld | Wert |
|---|---|
| **Dateipfad** | `little-data/langdock-deploy/knowledge/10-prompts-und-skills.md` |
| **H1** | `Prompts und Inline-Skills für Marketing-Direktoren` |
| **Pflicht-H2-Sub-Topics** (in dieser Reihenfolge) | - Was ist ein Inline-Skill, was ein Metaprompt
- PTCF-Skelett für alle Marketing-Aufgaben
- CO-STAR-Framework Alternative
- Format-Konversionen (Liste→Tabelle, CSV↔JSON, Prose→Bullets, etc.)
...
| **Marketing-Funktionen-Fokus** | alle Funktionen (täglicher Werkzeugkasten) |
...
### S-PS-001 [Szenario-Titel auf Deutsch]
...
Schreibe die Datei via `Write` direkt nach `little-data/langdock-deploy/knowledge/10-prompts-und-skills.md`. Erstelle danach einen sauberen Commit auf deinem Working-Branch mit dem Format `little-data: author 10-prompts-und-skills via Jules`.
...
> "Done. 10-prompts-und-skills: [N_lines] lines, [N_bytes] bytes, [N_scenarios] scenarios. Method-distribution: [Mxx: count, ...]. Validation: PASS [optional notes]."
