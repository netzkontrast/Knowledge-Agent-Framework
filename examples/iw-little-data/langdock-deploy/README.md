...
├── CONVERSATION_STARTERS.md   ← 15 starters for the Agent (10 platform + 5 IW-layer)
...
│   ├── 15-glossar-und-faq.md      ← Glossar (123 Begriffe) + FAQ (20 Einträge)
...
| Reference | `15`, `18` | Glossar (123 terms) + FAQ (20 entries); source & deeplink reference (`18`) |
...
- **System prompt (14 925 / 15 000 chars)** holds the persona identity, voice, modes, refusal strings, calibration examples (incl. the IW-Fachebene + HITL case), and the forced first-search bootstrap — it survives any retrieval miss.
